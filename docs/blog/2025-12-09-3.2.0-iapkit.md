---
slug: 3.2.0
title: 3.2.0 - Built-in Purchase Verification with IAPKit
authors: [hyochan]
...
if (result.isValid) {
  ...
  console.log('Purchase state:', result.state);
...
- `state` - Detailed purchase state (entitled, pending, expired, etc.)
