---
slug: v2-6-1-release
title: Version 2.6.1 - iOS AppTransaction Support
authors: [hyochan]
tags: [release, ios, apptransaction]
---

# Version 2.6.1 Release: Enhanced iOS AppTransaction Support

We're excited to announce the release of expo-iap version 2.6.1, which includes critical fixes for iOS AppTransaction functionality.
...
To upgrade to version 2.6.1:

```bash
npm install expo-iap@2.6.1
# or
yarn add expo-iap@2.6.1
# or
bun add expo-iap@2.6.1
```
